...
public class PlayerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            //... then sprint
            rBody2D.velocity = new Vector2(Input.GetAxis("Horizontal") * moveSpeed * Time.deltaTime * sprintMultiplier, rBody2D.velocity.y);
        ...
        else
        {
            ...
            rBody2D.velocity = new Vector2(Input.GetAxis("Horizontal") * moveSpeed * Time.deltaTime, rBody2D.velocity.y);
        }

        //If our player pressed the jump key...
        if (playerJumped)
        {
            rBody2D.AddForce(new Vector2(0, initialJumpForce)); //"Jump" our player up in the air!
        ...
        {
            rBody2D.AddForce(new Vector2(0, extraJumpForce)); //... then add some additional force to the jump
        }
    }
}
